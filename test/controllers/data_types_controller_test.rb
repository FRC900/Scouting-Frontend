...
class DataTypesControllerTest < ActionController::TestCase
  ...
  test "should create data_type" do
    assert_difference('DataType.count') do
      post :create, data_type: { category_id: @data_type.category_id, name: @data_type.name, type: @data_type.type }
    end
  ...
  test "should update data_type" do
    patch :update, id: @data_type, data_type: { category_id: @data_type.category_id, name: @data_type.name, type: @data_type.type }
    assert_redirected_to data_type_path(assigns(:data_type))
  end
